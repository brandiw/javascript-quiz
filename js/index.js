...
// 	$("#quizStart").hide();
// 	$("#quizQuestion").show();
// 	$("h3").text(allQuestions[0].question);
// 	$("#a1").text(allQuestions[0].choices[0]);
//  	$("#a2").text(allQuestions[0].choices[1]);
//  	$("#a3").text(allQuestions[0].choices[2]);
//  	$("#a4").text(allQuestions[0].choices[3]);
